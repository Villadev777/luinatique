    ...
    const fetchProducts = async () => {
      try {
        ...
        if (subcategory) {
          ...
          // Fetch all pin products (category = "prendedores")
          setCategoryInfo({
            title: 'Prendedores',
            description: 'Prendedores únicos que transforman cualquier outfit. Pequeños detalles que hacen una gran diferencia en tu estilo.'
          });

          // Get category section ID for "prendedores"
          ...
          // Get all subcategories for prendedores
          ...
          // Fetch products for all pin subcategories
          const { data: productsData, error: productsError } = await supabase
            .from('products')
            .select('*')
        ...
        <section className="py-20 bg-secondary/20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="font-playfair text-4xl md:text-6xl font-semibold text-foreground mb-6">
              {categoryInfo?.title || 'Prendedores'}
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              {categoryInfo?.description || 'Prendedores únicos que transforman cualquier outfit.'}
            </p>
          </div>
        </section>
            ...
            {products.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-muted-foreground mb-8">
                  Actualmente no tenemos prendedores en esta categoría, pero pronto habrá nuevos productos.
                </p>
              ...
              <>
                <div className="text-center mb-12">
                  ...
                  <p className="text-muted-foreground">
                    Encuentra el prendedor perfecto para ti
                  </p>
                </div>
        ...
        <section className="py-20 bg-secondary/10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-playfair text-3xl md:text-4xl font-semibold mb-6">
              ¿No encontraste el prendedor perfecto?
            </h2>
