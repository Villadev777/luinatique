    ...
    const fetchProducts = async () => {
      try {
        ...
        if (subcategory) {
          ...
          // Fetch all keychain products (category = "llaveros")
          setCategoryInfo({
            title: 'Llaveros',
            description: 'Llaveros únicos que transforman un objeto cotidiano en una pequeña obra de arte que te acompaña a todas partes.'
          });

          // Get category section ID for "llaveros"
          ...
          // Get all subcategories for llaveros
          ...
          // Fetch products for all keychain subcategories
          const { data: productsData, error: productsError } = await supabase
            .from('products')
            .select('*')
        ...
        <section className="py-20 bg-accent/20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="font-playfair text-4xl md:text-6xl font-semibold text-foreground mb-6">
              {categoryInfo?.title || 'Llaveros'}
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              {categoryInfo?.description || 'Llaveros únicos que transforman un objeto cotidiano en una pequeña obra de arte.'}
            </p>
          </div>
        </section>
            ...
            {products.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-muted-foreground mb-8">
                  Actualmente no tenemos llaveros en esta categoría, pero pronto habrá nuevos productos.
                </p>
              ...
              <>
                <div className="text-center mb-12">
                  ...
                  <p className="text-muted-foreground">
                    Encuentra el llavero perfecto para ti
                  </p>
                </div>
        ...
        <section className="py-20 bg-accent/10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-playfair text-3xl md:text-4xl font-semibold mb-6">
              ¿No encontraste el llavero perfecto?
            </h2>
