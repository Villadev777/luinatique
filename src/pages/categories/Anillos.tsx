    ...
    const fetchProducts = async () => {
      try {
        ...
        if (subcategory) {
          ...
          // Fetch all ring products (category = "anillos")
          setCategoryInfo({
            title: 'Anillos',
            description: 'Descubre nuestra exquisita colección de anillos, desde diseños minimalistas hasta piezas de declaración que capturan la esencia de la elegancia atemporal.'
          });

          // Get category section ID for "anillos"
          ...
          // Get all subcategories for anillos
          ...
          // Fetch products for all ring subcategories
          const { data: productsData, error: productsError } = await supabase
            .from('products')
            .select('*')
        ...
        <section className="py-20 bg-sage/10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="font-playfair text-4xl md:text-6xl font-semibold text-foreground mb-6">
              {categoryInfo?.title || 'Anillos'}
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              {categoryInfo?.description || 'Descubre nuestra exquisita colección de anillos.'}
            </p>
          </div>
        </section>
              ...
              <>
                <div className="text-center mb-12">
                  ...
                  <p className="text-muted-foreground">
                    Encuentra el anillo perfecto para ti
                  </p>
                </div>
        ...
        <section className="py-20 bg-sage/5">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-playfair text-3xl md:text-4xl font-semibold mb-6">
              ¿No encontraste el anillo perfecto?
            </h2>
