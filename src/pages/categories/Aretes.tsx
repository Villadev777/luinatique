    ...
    const fetchProducts = async () => {
      try {
        ...
        if (subcategory) {
          ...
          // Fetch all earring products (category = "aretes")
          setCategoryInfo({
            title: 'Aretes',
            description: 'Encuentra el par perfecto de aretes para cada ocasión. Desde diseños sutiles para el día hasta piezas llamativas para la noche.'
          });

          // Get category section ID for "aretes"
          ...
          // Get all subcategories for aretes
          ...
          // Fetch products for all earring subcategories
          const { data: productsData, error: productsError } = await supabase
            .from('products')
            .select('*')
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
            ...
            {products.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-muted-foreground mb-8">
                  Actualmente no tenemos aretes en esta categoría, pero pronto habrá nuevos productos.
                </p>
              ...
              <>
                <div className="text-center mb-12">
                  ...
                  <p className="text-muted-foreground">
                    Encuentra el par perfecto de aretes para ti
                  </p>
                </div>
        ...
        {/* CTA Section */}
        <section className="py-20 bg-luxury/5">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-playfair text-3xl md:text-4xl font-semibold mb-6">
              ¿No encontraste los aretes perfectos?
            </h2>
