    ...
    const fetchProducts = async () => {
      try {
        ...
        if (subcategory) {
          ...
          // Fetch all necklace products (category = "collares")
          setCategoryInfo({
            title: 'Collares',
            description: 'Collares que complementan tu estilo único. Desde piezas minimalistas hasta diseños elaborados que capturan la atención.'
          });

          // Get category section ID for "collares"
          ...
          // Get all subcategories for collares
          ...
          // Fetch products for all necklace subcategories
          const { data: productsData, error: productsError } = await supabase
            .from('products')
            .select('*')
        ...
        <section className="py-20 bg-cream/50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="font-playfair text-4xl md:text-6xl font-semibold text-foreground mb-6">
              {categoryInfo?.title || 'Collares'}
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              {categoryInfo?.description || 'Collares que complementan tu estilo único.'}
            </p>
          </div>
        </section>
            ...
            {products.length === 0 ? (
              <div className="text-center py-16">
                ...
                <p className="text-muted-foreground mb-8">
                  Actualmente no tenemos collares en esta categoría, pero pronto habrá nuevos productos.
                </p>
              ...
              <>
                <div className="text-center mb-12">
                  ...
                  <p className="text-muted-foreground">
                    Encuentra el collar perfecto para ti
                  </p>
                </div>
        ...
        <section className="py-20 bg-cream/30">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-playfair text-3xl md:text-4xl font-semibold mb-6">
              ¿No encontraste el collar perfecto?
            </h2>
